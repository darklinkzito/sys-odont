...
<head>
    ...
    <meta name="description"
        content="How to make a simple wizard, workflow or sequence to steps using a Bootstrap modal and the progress bar to show progress." />
...
<body>
    ...
    <div class="container">
        <h3>Bootstrap Wizard with Modal</h3>
    ...
    $(document).ready(function() {
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
            ...
            $('.progress-bar').text("Passo " + step + " of 4");
